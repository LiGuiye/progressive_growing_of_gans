...
# Dataset (choose one).
desc += '-dem_merge_512';              dataset = EasyDict(tfrecord_dir='dem_merge_512')
...
desc += '-preset-v3-1gpu'; num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {4: 128, 8: 128, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8, 512: 4}; sched.G_lrate_dict = {1024: 0.0015}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 12000
